...
public class functionAController {
     ...
     */
    private void Release_Result(int Opt_Noir,int Opt_Rose, float Opt_Profit, float Opt_Margin){
    ...
    public void toclick(ActionEvent actionEvent) {
        ...
        Release_Result(Opt_Revenue,Opt_Noir,Opt_Rose,Opt_Margin);
